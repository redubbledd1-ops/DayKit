...
class AlarmActiefSwitch(DayKitEntity, SwitchEntity):
...
class MobielBetrouwbaarSwitch(DayKitEntity, SwitchEntity):
...
class GebruikerThuisSwitch(DayKitEntity, SwitchEntity):
