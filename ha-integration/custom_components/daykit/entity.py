"""Gedeelde basis-entity voor DayKit entities."""
...
class DayKitEntity(Entity):
    ...
    def __init__(self, hub, entry: ConfigEntry, key: str, name: str) -> None:
        ...
        self._attr_device_info = DeviceInfo(
            ...
            # De apparaatnaam bepaalt het eerste deel van elk entity_id dat HA hieronder
            # aanmaakt (sensor.daykit_...). Aanpassen hiervan hernoemt bestaande entities
            # dus NIET - die staan al in het entity-register - maar geeft wel een nieuwe
            # installatie andere id's dan een oude. Sinds de domeinwissel naar "daykit"
            # is dat geen probleem meer: iedereen koppelt sowieso opnieuw.
            name="DayKit",
            manufacturer="DayKit",
            model="Agenda-alarm watchdog",
        )
