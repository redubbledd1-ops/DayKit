"""Button entity voor AgendaAlarm Backup: genereert een kortdurende koppelcode."""
...
class GeneratePairingCodeButton(AgendaAlarmBackupEntity, ButtonEntity):
    ...
    sensor.agendaalarm_koppelcode voor de code zelf + de QR-afbeelding.
    ...
    async def async_press(self) -> None:
        ...
        try:
            await self.hass.services.async_call(
                ...
                "create",
                {
                    "title": "AgendaAlarm pairing code",
                    "message": (
                        f"Code: **{code}** (valid for 5 minutes, single use).\n\n"
                        "Scan the QR code (sensor.agendaalarm_koppelcode) with the "
                        "AgendaAlarm app, or enter this code manually under "
