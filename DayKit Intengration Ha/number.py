"""Number entities voor AgendaAlarm Backup (volume + herhaal-interval)."""
...
class FallbackVolumeNumber(AgendaAlarmBackupEntity, NumberEntity):
...
class FallbackIntervalNumber(AgendaAlarmBackupEntity, NumberEntity):
